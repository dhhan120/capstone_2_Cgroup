...
class ball_position_2 {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('b_radius')) {
        this.b_radius = initObj.b_radius
      }
      else {
        this.b_radius = [];
      }
      if (initObj.hasOwnProperty('r_radius')) {
        this.r_radius = initObj.r_radius
      }
      else {
        this.r_radius = [];
      }
      if (initObj.hasOwnProperty('g_radius')) {
        this.g_radius = initObj.g_radius
      }
      else {
        this.g_radius = [];
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [b_radius]
    bufferOffset = _arraySerializer.float32(obj.b_radius, buffer, bufferOffset, null);
    // Serialize message field [r_radius]
    bufferOffset = _arraySerializer.float32(obj.r_radius, buffer, bufferOffset, null);
    // Serialize message field [g_radius]
    bufferOffset = _arraySerializer.float32(obj.g_radius, buffer, bufferOffset, null);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ball_position_2(null);
    ...
    // Deserialize message field [b_radius]
    data.b_radius = _arrayDeserializer.float32(buffer, bufferOffset, null)
    // Deserialize message field [r_radius]
    data.r_radius = _arrayDeserializer.float32(buffer, bufferOffset, null)
    // Deserialize message field [g_radius]
    data.g_radius = _arrayDeserializer.float32(buffer, bufferOffset, null)
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += 4 * object.b_radius.length;
    length += 4 * object.r_radius.length;
    length += 4 * object.g_radius.length;
    return length + 60;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ball_position_2(null);
    ...
    if (msg.b_radius !== undefined) {
      resolved.b_radius = msg.b_radius;
    }
    else {
      resolved.b_radius = []
    }

    if (msg.r_radius !== undefined) {
      resolved.r_radius = msg.r_radius;
    }
    else {
      resolved.r_radius = []
    }

    if (msg.g_radius !== undefined) {
      resolved.g_radius = msg.g_radius;
    }
    else {
      resolved.g_radius = []
    }
...
module.exports = ball_position_2;
