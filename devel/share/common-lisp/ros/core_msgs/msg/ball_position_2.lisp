...
;//! \htmlinclude ball_position_2.msg.html

(cl:defclass <ball_position_2> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass ball_position_2 (<ball_position_2>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <ball_position_2>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'ball_position_2)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name core_msgs-msg:<ball_position_2> is deprecated: use core_msgs-msg:ball_position_2 instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <ball_position_2>))
...
(cl:defmethod r_size-val ((m <ball_position_2>))
...
(cl:defmethod b_size-val ((m <ball_position_2>))
...
(cl:defmethod g_size-val ((m <ball_position_2>))
...
(cl:defmethod b_img_x-val ((m <ball_position_2>))
...
(cl:defmethod b_img_y-val ((m <ball_position_2>))
...
(cl:defmethod b_img_z-val ((m <ball_position_2>))
...
(cl:defmethod r_img_x-val ((m <ball_position_2>))
...
(cl:defmethod r_img_y-val ((m <ball_position_2>))
...
(cl:defmethod r_img_z-val ((m <ball_position_2>))
...
(cl:defmethod g_img_x-val ((m <ball_position_2>))
...
(cl:defmethod g_img_y-val ((m <ball_position_2>))
...
(cl:defmethod g_img_z-val ((m <ball_position_2>))
...
(cl:ensure-generic-function 'b_radius-val :lambda-list '(m))
(cl:defmethod b_radius-val ((m <ball_position_2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader core_msgs-msg:b_radius-val is deprecated.  Use core_msgs-msg:b_radius instead.")
  (b_radius m))

(cl:ensure-generic-function 'r_radius-val :lambda-list '(m))
(cl:defmethod r_radius-val ((m <ball_position_2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader core_msgs-msg:r_radius-val is deprecated.  Use core_msgs-msg:r_radius instead.")
  (r_radius m))

(cl:ensure-generic-function 'g_radius-val :lambda-list '(m))
(cl:defmethod g_radius-val ((m <ball_position_2>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader core_msgs-msg:g_radius-val is deprecated.  Use core_msgs-msg:g_radius instead.")
  (g_radius m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <ball_position_2>) ostream)
  "Serializes a message object of type '<ball_position_2>"
  ...
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'b_radius))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-single-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)))
   (cl:slot-value msg 'b_radius))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'r_radius))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-single-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)))
   (cl:slot-value msg 'r_radius))
  (cl:let ((__ros_arr_len (cl:length (cl:slot-value msg 'g_radius))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) __ros_arr_len) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) __ros_arr_len) ostream))
  (cl:map cl:nil #'(cl:lambda (ele) (cl:let ((bits (roslisp-utils:encode-single-float-bits ele)))
    ...
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)))
   (cl:slot-value msg 'g_radius))
)
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <ball_position_2>) istream)
  "Deserializes a message object of type '<ball_position_2>"
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'b_radius) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'b_radius)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'r_radius) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'r_radius)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
  ...
  (cl:let ((__ros_arr_len 0))
    ...
    (cl:setf (cl:ldb (cl:byte 8 16) __ros_arr_len) (cl:read-byte istream))
    (cl:setf (cl:ldb (cl:byte 8 24) __ros_arr_len) (cl:read-byte istream))
  (cl:setf (cl:slot-value msg 'g_radius) (cl:make-array __ros_arr_len))
  (cl:let ((vals (cl:slot-value msg 'g_radius)))
    (cl:dotimes (i __ros_arr_len)
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ball_position_2>)))
  "Returns string type for a message object of type '<ball_position_2>"
  "core_msgs/ball_position_2")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ball_position_2)))
  "Returns string type for a message object of type 'ball_position_2"
  "core_msgs/ball_position_2")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<ball_position_2>)))
  "Returns md5sum for a message object of type '<ball_position_2>"
  "3964fceb24b14dfa82dd195b9fd6d440")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'ball_position_2)))
  "Returns md5sum for a message object of type 'ball_position_2"
  "3964fceb24b14dfa82dd195b9fd6d440")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<ball_position_2>)))
  "Returns full string definition for message of type '<ball_position_2>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'ball_position_2)))
  "Returns full string definition for message of type 'ball_position_2"
  (cl:format cl:nil "Header header~%int32 r_size~%int32 b_size~%int32 g_size~%~%float32[] b_img_x~%float32[] b_img_y~%float32[] b_img_z~%~%float32[] r_img_x~%float32[] r_img_y~%float32[] r_img_z~%~%float32[] g_img_x~%float32[] g_img_y~%float32[] g_img_z~%~%float32[] b_radius~%float32[] r_radius~%float32[] g_radius~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <ball_position_2>))
  (cl:+ 0
     ...
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'b_radius) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'r_radius) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
     4 (cl:reduce #'cl:+ (cl:slot-value msg 'g_radius) :key #'(cl:lambda (ele) (cl:declare (cl:ignorable ele)) (cl:+ 4)))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <ball_position_2>))
  "Converts a ROS message object to a list"
  (cl:list 'ball_position_2
